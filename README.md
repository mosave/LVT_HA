...
- **<text>**: фраза или список фраз для проговаривания. Если список содержит несколько фраз то LVT выберет одну из них случайным образом.
  ...
  - ударе☺ния (символ с кодом 0301 ставится после ударной гласной)
  - Удар+ение (символ "+", ставится непосредственно перед ударной гласной)
  - **[<слово или текст> : <список тегов>]**: Постановка слов в нужную форму, в соответствии со [списком переданных тегов](https://pymorphy2.readthedocs.io/en/stable/user/grammemes.html). Например текст "Я не могу найти [зеленый хомяк: gent]" будет преобразован в "Я не могу найти зеленого хомяка"
  - **[<слово или текст> : <число>]**: согласование слов с числом, например текст "Температура на улице 15 [градус:15]" будет произнесен как "Температура на улице пятнадцать градусов"
